...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-mymedi--pass.vercel.app-0070eb?style=for-the-badge&logo=vercel)](https://mymedi-pass.vercel.app)
...
| Web App (React MVP) | React 19 + TypeScript + Vite + Tailwind CSS v4 |
| Hosting | Vercel (프로덕션 배포) |
...
## React 웹앱 로컬 실행 및 Vercel 배포

본 레포지토리에는 Google Sheets 시뮬레이터 외에 **React 19 + Vite 기반 모바일 웹앱**이 포함되어 있습니다.
...
배포 후 영구 URL: **https://mymedi-pass.vercel.app**

### 앱 구성 화면

| 탭 | 기능 |
| --- | --- |
| 홈 | DID 인증 상태, 의료 데이터 통계, 최근 활동 내역 |
| 지갑 | OpenDID 기반 의료 자격증명(VC) 관리 및 신규 발급 |
| 랭킹 | 실시간 블록체인 트랜잭션 기반 병원 인기 순위 |
| 내 정보 | 청구 상세 정보 및 원클릭 보험 청구 |
